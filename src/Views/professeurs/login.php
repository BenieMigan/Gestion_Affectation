    ...
    <div class="bg-white shadow-xl rounded-3xl flex flex-col md:flex-row overflow-hidden max-w-4xl w-full">
        ...
        <div class="md:w-1/2 bg-blue-600 text-white flex items-center justify-center p-10">
            <div class="text-center space-y-4">
                ...
                <p class="text-lg font-light">Connecte-toi pour voir tes étudiants et suivre leur encadrement.</p>
                <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Professeur icon" class="w-32 mx-auto">
            </div>
        </div>
